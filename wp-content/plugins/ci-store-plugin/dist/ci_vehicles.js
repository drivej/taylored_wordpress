(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ci_vehicles", [], factory);
	else if(typeof exports === 'object')
		exports["ci_vehicles"] = factory();
	else
		root["ci_vehicles"] = factory();
})(self, () => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#vehicle-fitment{background-color:green}`, "",{"version":3,"sources":["webpack://./src/view/vehicles/vehicles.scss"],"names":[],"mappings":"AAAA,iBACE,sBAAA","sourcesContent":["#vehicle-fitment {\n  background-color: green;\n}\n"],"sourceRoot":""}]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/@tanstack/query-sync-storage-persister/build/modern/utils.js
// src/utils.ts
function noop() {
}

//# sourceMappingURL=utils.js.map
;// CONCATENATED MODULE: ./node_modules/@tanstack/query-sync-storage-persister/build/modern/index.js
// src/index.ts
...
;// CONCATENATED MODULE: ./node_modules/@tanstack/query-persist-client-core/build/modern/persist.js
// src/persist.ts
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  react.useSyncExternalStore(
    react.useCallback(
      (onStoreChange) => {
        const unsubscribe = shouldSubscribe ? observer.subscribe(notifyManager.batchCalls(onStoreChange)) : modern_utils_noop;
  ...
  if (defaultedOptions.experimental_prefetchInRender && !isServer && willFetch(result, isRestoring)) {
    ...
    promise?.catch(modern_utils_noop).finally(() => {
      observer.updateResult();
    });
  }
...
;// CONCATENATED MODULE: ./src/view/vehicles/utils/useFitment.tsx
...
const fetchVehicles = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield fetch(window.vehicles_ajax.url, {
        method: 'POST',
        headers: {
...
const useFitment = (vehicle_id, options = {}) => {
    var _a;
    const type = 'fitment';
    const product_id = (_a = window.vehicles_ajax) === null || _a === void 0 ? void 0 : _a.product_id;
    return useQuery(Object.assign({ queryKey: ['vehicles', type, product_id, vehicle_id], queryFn: () => fetchVehicles({ type, product_id, vehicle_id }), enabled: () => !!product_id && !!vehicle_id && vehicle_id > 0 }, options));
};

;// CONCATENATED MODULE: ./src/view/vehicles/utils/useInterop.tsx

const useInterop = (onMessage) => {
...
;// CONCATENATED MODULE: ./src/view/vehicles/VehicleFitment.tsx
...
const VehicleFitment = () => {
    ...
    const onChangeVariationId = (e) => {
        if (e.currentTarget.value !== '') {
            setSelectedVariationId(parseInt(e.currentTarget.value));
        }
    };
    const interop = useInterop(handler);
    const [vehicleId, setVehicleId] = (0,react.useState)(0);
    const [selectedVariationId, setSelectedVariationId] = (0,react.useState)(null);
    const fitment = useFitment(vehicleId);
    const [variationInput, setVariationInput] = (0,react.useState)(null);
    (0,react.useEffect)(() => {
        if (selectedVariationId) {
            vehicles.selectVariation(selectedVariationId);
        }
    }, [selectedVariationId]);
    const onChangeVariationId2 = (0,lodash.debounce)(() => {
        console.log('onChangeVariationId2', variationInput === null || variationInput === void 0 ? void 0 : variationInput.value);
        if (variationInput === null || variationInput === void 0 ? void 0 : variationInput.value) {
            if (parseInt(variationInput === null || variationInput === void 0 ? void 0 : variationInput.value) !== selectedVariationId) {
                setSelectedVariationId(parseInt(variationInput === null || variationInput === void 0 ? void 0 : variationInput.value));
            }
        }
    }, 1000);
    // find variation input
    (0,react.useEffect)(() => {
        setVariationInput(document.querySelector('input[name="variation_id"]'));
    }, []);
    // listen to changes
    (0,react.useEffect)(() => {
        if (variationInput) {
    ...
    return (react.createElement("div", { id: 'vehicle-fitment', className: 'p-2 d-none' },
        "Vehicle cFitment ",
        react.createElement("button", { onClick: () => interop.send({ action: 'change_variation_id', payload: '492720' }) }, "TEST"),
        react.createElement("button", { onClick: () => setVehicleId(10843) }, "Vehicle 10843"),
        react.createElement("button", { onClick: () => setVehicleId(50605) }, "Vehicle 50605"),
        react.createElement("select", { className: 'form-control', value: selectedVariationId, onChange: onChangeVariationId, disabled: ((_b = (_a = fitment.data) === null || _a === void 0 ? void 0 : _a.variation_ids) !== null && _b !== void 0 ? _b : []).length == 0 },
            react.createElement("option", { value: '' }, "Select..."), (_d = (_c = fitment.data) === null || _c === void 0 ? void 0 : _c.variation_ids) === null || _d === void 0 ? void 0 :
            _d.map((id) => react.createElement("option", { value: id }, id))),
        react.createElement("div", null,
            react.createElement("pre", { style: { background: '#000', color: 'orange', fontSize: 11 } }, JSON.stringify({ vehicles: fitment.data }, null, 2)))));
};
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/view/vehicles/vehicles.scss
var vehicles_vehicles = __webpack_require__(106);
;// CONCATENATED MODULE: ./src/view/vehicles/vehicles.scss
...
var update = injectStylesIntoStyleTag_default()(vehicles_vehicles/* default */.Z, options);




       /* harmony default export */ const view_vehicles_vehicles = (vehicles_vehicles/* default */.Z && vehicles_vehicles/* default */.Z.locals ? vehicles_vehicles/* default */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/view/vehicles/index.tsx
...
const render = (id) => {
    ...
    root.render(react.createElement(QueryClientProvider, { client: queryClient },
        react.createElement(VehicleFitment, null)));
};
...
//# sourceMappingURL=ci_vehicles.js.map