...
*/
export interface IWooParams extends Partial<IWooVariable> {
  ...
  _fields?: string;
  force?: boolean;
  update?: Partial<IWooVariable | IWooVariation>[];
  delete?: unknown;
  create?: Partial<IWooVariable | IWooVariation | IWooCategory>[];
}

export interface IWooVariable {
...
export interface IWooVariation extends Omit<IWooVariable, 'attributes'> {
...
export interface IWooSimpleProduct extends Omit<IWooVariable, 'attributes'> {
  image: IWooImage;
  _ci_data: string;
}
